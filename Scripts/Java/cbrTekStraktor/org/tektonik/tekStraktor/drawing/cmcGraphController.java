...
import org.tektonik.tekStraktor.textDatabase.kloonTextObject;
...
//System.out.println("===================");
	...
	//---------------------------------------------------------------------------------
	{
		...
		// info object
		Color kolor=iKol.ColorLabel2Color("lightyellow");
		...
		kolor = iKol.ColorLabel2Color(sKolor);
