...
import org.tektonik.MachineLearning.dao.cmcARFFDAO;
import org.tektonik.tekStraktor.featureExtraction.cmcFeatureCollection.SCORE;
import org.tektonik.tekStraktor.featureExtraction.cmcHaralick.CHANNEL;
import org.tektonik.tekStraktor.featureExtraction.cmcHaralick.ORIENTATION;
...
public class cmcVRExtractMLAndHOGFeatureSet {
    ...
    //------------------------------------------------------------
    {
    	...
    	xproto.getAttributeList()[0].setTipe( ARFF_TYPE.STRING );
    	...
    	xproto.getAttributeList()[1].setTipe( ARFF_TYPE.CLASS );
    	...
    	xfeat.getAttributeList()[0].setTipe( ARFF_TYPE.STRING );
    	...
    	xfeat.getAttributeList()[1].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[2].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[3].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[4].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[5].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[6].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[7].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[8].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[9].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[10].setTipe( ARFF_TYPE.NUMERIC );
    	xfeat.getAttributeList()[10].setClassesDefinition("N/A");
    	xfeat.getAttributeList()[10].setClasses(null);
    	//
    	xfeat.getAttributeList()[11].setAttrName("meanLightness");
    	xfeat.getAttributeList()[11].setTipe( ARFF_TYPE.NUMERIC );
    	...
    	xfeat.getAttributeList()[12].setTipe( ARFF_TYPE.NOMINAL );
    	...
    	xfeat.getAttributeList()[13].setTipe( ARFF_TYPE.CLASS );
