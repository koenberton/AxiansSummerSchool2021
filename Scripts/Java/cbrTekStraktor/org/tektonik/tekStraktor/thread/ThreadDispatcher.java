...
public class ThreadDispatcher {
    ...
    //----------------------------------------------------------------
    {
		...
		if (moni != null) moni.syncMonitor();
		if( xMSet.TENSOR_SIMULATOR ) {  // always return true in simulator mode
			if( errors > 0 ) do_error( "Although errors occured, these will be ignored because in SIMULATOR mode");
			return true;
		}
