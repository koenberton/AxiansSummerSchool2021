package org.tektonik.tekStraktor.project;


import org.tektonik.tekStraktor.dao.cmcMakeCSSFile;
import org.tektonik.tekStraktor.dao.cmcProjectDAO;
...
public class cmcFolderInitialization {
    ...
    public String getBayesDir()       { return sBayesDir; }
    //	
	...
	//---------------------------------------------------------------------------------
	{
	    ...
	    //
	    sBayesDir = sRootDir + xMSet.xU.ctSlash + "MachineLearning";
	    if( xMSet.xU.IsDir(sBayesDir) == false ) 
	    {
	    	if( fixit ) {
	    		createFolder(sBayesDir);
	    		createFolder(sBayesDir + xMSet.xU.ctSlash + "Text");
	    		createFolder(sBayesDir + xMSet.xU.ctSlash + "Mixed");
	    		createFolder(sBayesDir + xMSet.xU.ctSlash + "Graph");
	    		createFolder(sBayesDir + xMSet.xU.ctSlash + "ValidBubble");
	    		createFolder(sBayesDir + xMSet.xU.ctSlash + "InValidBubble");
	    		createFolder(sBayesDir + xMSet.xU.ctSlash + "Model");
	    		createFolder(sBayesDir + xMSet.xU.ctSlash + "SandBox");
	    	}
	    	else {
	    	 ErrIt("MachineLearning folder [" + sBayesDir + "] cannot be accessed");
	    	 isOK=false;
	    	}
	    }
	    //
	    String sSandBoxDir = sBayesDir + xMSet.xU.ctSlash + "SandBox";
	    if( xMSet.xU.IsDir(sSandBoxDir) == false ) 
	    {
	    	if( fixit ) {
	    		createFolder(sSandBoxDir);
	    		createFolder(sSandBoxDir + xMSet.xU.ctSlash + "Source");
	    		createFolder(sSandBoxDir + xMSet.xU.ctSlash + "Test");
	    		createFolder(sSandBoxDir + xMSet.xU.ctSlash + "Train");
	    		createFolder(sSandBoxDir + xMSet.xU.ctSlash + "Tmp");
	    	}
	    	else {
	    	 ErrIt("SandBox folder [" + sSandBoxDir + "] cannot be accessed");
	    	 isOK=false;
	    	}
	    }
	    //
	    sTensorDir = sBayesDir + xMSet.xU.ctSlash + "Tensorflow";
