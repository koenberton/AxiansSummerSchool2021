...
public class cmcProjectWrapper {
    ...
    public String getBayesDir()       { return ina.getBayesDir(); }
    //
    //
    ...
    public void setTensorCoverage(cmcProcEnums.REASSESMENT_COVERAGE c) { core.setTensorCoverage(c); }
	//public void setALsoRunTensorFlow(boolean b)               { core.setALsoRunTensorFlow(b); }
	public void setALsoRunTesseract(boolean b)                { core.setALsoRunTesseract(b);}
	public void setPostProcessAIType(cmcProcEnums.MACHINE_LEARNING_TYPE c) { core.setPostProcessAIType(c); }
    ...
    public cmcProcEnums.REASSESMENT_COVERAGE getTensorCoverage() { return core.getTensorCoverage(); }
    public boolean getAlsoRunTesseract()                { return core.getAlsoRunTesseract(); }
    //public boolean getAlsoRunTensorFlow()                   { return core.getAlsoRunTensorFlow(); }
    public cmcProcEnums.MACHINE_LEARNING_TYPE getPostProcessAIType()  { return core.getPostProcessAIType(); }
    public String getSplashPictureName()         { return core.getSplashPictureName(); }
