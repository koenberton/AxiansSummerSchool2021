...
public class cmcProcEnums {
	...
	//
	public enum MACHINE_LEARNING_TYPE { UNKNOWN , TENSORFLOW , BAYES , MULTI_LAYER_PERCEPTRON , DECISION_TREE , LOGISTIC_REGRESSION , SMO , SVM , K_NEAREST_NEIGHBOURS }
	//public enum AI_TYPES { UNKNOWN , BAYES , TENSORFLOW , SVM , DECISION_TREE , KNN }
	
	public enum MENU_ITEMS_STD {
	...
	public enum MENU_ITEMS_ML {
		 //PROJECT_START , OPEN_PROJECT , EDIT_PROJECT , NEW_PROJECT , PROJECT_STOP ,
		 OPEN_IMAGE , //OPEN_REPORT , OPEN_ARCHIVE , 
		 DIV1 , SAVE , 
		 DIV2 , INFO , TOGGLE_DETAIL_PANE , REFRESH , 
		 //DIV3 , 
		 //IMPORT , IMPORT_TEXT , IMPORT_CONT ,
		 ...
		 NEURAL_NETWORK, NEURAL_NETWORK_BUILDER , NEURAL_NETWORK_CONT ,
