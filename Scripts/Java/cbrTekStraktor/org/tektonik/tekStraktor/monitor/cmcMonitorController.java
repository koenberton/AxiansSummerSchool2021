...
public class cmcMonitorController {
    ...
    private cmcMonitorDialog previousMonitorHandle=null;
    ...
    /*
    public void pushMonitorHandle()
    {
    	previousMonitorHandle = monitorHandle;
    }
    public void popMonitorHandle()
    {
    	monitorHandle = previousMonitorHandle;
    }
    */
}
