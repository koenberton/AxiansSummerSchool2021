...
public class cmcTesseractOptionModel extends AbstractTableModel {

	cmcProcSettings xMSet = null;
	cmcTesseractOptionModelObject GraphObject = null;
	...
	//
	//---------------------------------------------------------------------------------
	cmcTesseractOptionModel(cmcProcSettings iS , Object o , logLiason ilog)
	//---------------------------------------------------------------------------------
	{
		xMSet = iS;
		CallingClass=o;
		...
		//---------------------------------------------------------------------------------
		{
			...
			GraphObject = new cmcTesseractOptionModelObject(xMSet,logger);
