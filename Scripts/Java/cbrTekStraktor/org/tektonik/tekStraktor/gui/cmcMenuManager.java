...
public class cmcMenuManager {
	...
	//---------------------------------------------------------------------------------
	{
		...
		for(int i=0;i<org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.values().length;i++)
		{
			k++;
			String sText = org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.values()[i].toString();
	...
	//---------------------------------------------------------------------------------
	{
		org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD pdx = null;
		try {
		  if( iO == null ) return;
...
//System.err.println( mi.getFont().toString() + " " + mi.getLabel());
		  ...
		  if( idx < 0 ) return;
		  pdx = org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.values()[idx];
		}
		catch( Exception e ) {
			return;
		}
	...
	//---------------------------------------------------------------------------------
	public void setMenuItemStatus(org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD mi , boolean stat)
	//---------------------------------------------------------------------------------
	{
		  int idx=-1;
		  for(int i=0;i<org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.values().length;i++)
		  {
			if( mi == org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.values()[i] ) {
				idx=i;
				break;
			}
		  }
	...
	//---------------------------------------------------------------------------------
	public void setMenuItemVisible(org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD mi , boolean stat)
	//---------------------------------------------------------------------------------
	{
			  int idx=-1;
			  for(int i=0;i<org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.values().length;i++)
	...
	//---------------------------------------------------------------------------------
	{
		setMenuItemVisible( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.START_EDIT , true );
		setMenuItemVisible( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.STOP_EDIT , false);
		setMenuItemVisible( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.QUICK_EDIT , false);
		setMenuItemVisible( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.DETAILED_EDIT , false);
		//	
		if( (as == org.tektonik.tekStraktor.model.cmcProcEnums.APPLICATION_STATE.IDLE) ) {
			...
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.OPEN_PROJECT , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EDIT_PROJECT , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.NEW_PROJECT , true );
			//
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.OPEN_IMAGE , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.OPEN_REPORT , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.OPEN_ARCHIVE , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.INFO , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.TOGGLE_DETAIL_PANE , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.GENERAL_PROPERTIES , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.TESSERACT_OPTIONS , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.TESSERACT_VERSION , true );
			//
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MACHINE_LEARNING_MODELER , true );
			//
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MAKE_NAIVE_BAYES_TRAINING_SET , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXTRACT_NAIVE_BAYES_FEATURES  , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.TRAIN_NAIVE_BAYES_MODEL , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXTRACT_NAIVE_BAYES_SINGLE_SET , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.READJUST_TEXTBUBBLES_VIA_NAIVE_BAYES , true );
			//
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MAKE_DECISION_TREE_TRAINING_SET , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXTRACT_DECISION_TREE_FEATURES  , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.TRAIN_DECISION_TREE_MODEL , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXTRACT_DECISION_TREE_SINGLE_SET , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.READJUST_TEXTBUBBLES_VIA_DECISION_TREE , true );
			//
			...
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.TRAIN_KNN_MODEL , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXTRACT_KNN_SINGLE_SET , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.READJUST_TEXTBUBBLES_VIA_KNN , true );
		    //
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MAKE_SVM_TRAINING_SET , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXTRACT_SVM_FEATURES  , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXTRACT_SVM_SINGLE_SET , true );
			//
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MAKE_TENSORFLOW_TRAINING_SET , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXTRACT_TENSORFLOW_SINGLE_SET , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.READJUST_TEXTBUBBLES_VIA_TENSORFLOW , true );
			//
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.RECENT1 , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.RECENT2 , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.RECENT3 , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.RECENT4 , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.RECENT5 , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXIT , true );
			//
		    setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.LOAD_IMAGE , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXTRACT_TEXT , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.START_EDIT , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.TRANSLATE , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.REINJECT , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.OCR , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.REPORT , true );
			//
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.HOUSEKEEPING , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.STATISTICS , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MONITOR , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.ARCHIVE_VIEWER , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.ARCHIVE_BROWSER , true );
		    //
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.IMPORT_TEXT , true );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXPORT_TEXT , true );
		...
		if( (as == org.tektonik.tekStraktor.model.cmcProcEnums.APPLICATION_STATE.EDIT) ) {
		  ...
		  //
		  setMenuItemVisible( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.START_EDIT , false );
		  setMenuItemVisible( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.STOP_EDIT , true );
		  setMenuItemVisible( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.QUICK_EDIT , true);
		  setMenuItemVisible( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.DETAILED_EDIT , true);
		  //
		  setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.STOP_EDIT , true );
		  setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.QUICK_EDIT , true );
		  setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.DETAILED_EDIT , true );
		  //
		  setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.SAVE , true );
		  setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EDIT_OPTIONS , true );
		  setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.EXIT , true );
		...
		if( (as == org.tektonik.tekStraktor.model.cmcProcEnums.APPLICATION_STATE.EXTRACTED) ||
			...
			// disable filters
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.ORIGINAL , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.BLUEPRINT , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MAINFRAME , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MONOCHROME_NIBLAK, false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MONOCHROME_SAUVOLA , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.MONOCHROME_OTSU , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.BLEACHED , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.GRAYSCALE , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.ORIGINAL , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.INVERT , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.SOBEL_ON_GRAYSCALE , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.SOBEL , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.HISTOGRAM_EQUALISATION , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.GRADIENT_WIDE , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.GRADIENT_NARROW , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.GRADIENT_MAGNITUDE , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.GRADIENT_THETA , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.VERTICAL_GRADIENT , false );
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.HORIZONTAL_GRADIENT , false );
			
			setMenuItemStatus( org.tektonik.tekStraktor.model.cmcProcEnums.MENU_ITEMS_STD.HOUSEKEEPING ,false );
			//
			return;
		}
