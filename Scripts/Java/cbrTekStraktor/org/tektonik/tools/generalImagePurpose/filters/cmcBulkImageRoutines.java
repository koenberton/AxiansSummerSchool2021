package org.tektonik.tools.generalImagePurpose.filters;
...
import org.tektonik.tools.generalImagePurpose.analysis.cmcMaxLloydQuantization;
...
public class cmcBulkImageRoutines {
	...
	//-----------------------------------------------------------------------
	public int[] doConvolution(int[] pixels , org.tektonik.tools.generalImagePurpose.filters.cmcProcConvolution.kernelType kernelTipe , int width , int heigth)
	//-----------------------------------------------------------------------
	{
		int[] work = new int[ pixels.length ];
