package org.tektonik.tools.generalImagePurpose;
...
public class cmcImageRoutines {
	...
	//-----------------------------------------------------------------------
	public BufferedImage resizeImage(BufferedImage originalImage, int iwidth , int iheigth , double scale )
	//-----------------------------------------------------------------------
	{
			resizeWidth=0;
			resizeHeigth=0;
		    ...
		    resizeHeigth = (resizeWidth * iheigth) / iwidth;
		    //
		    BufferedImage resizedImage = new BufferedImage(resizeWidth, resizeHeigth, originalImage.getType());
		    Graphics2D g = resizedImage.createGraphics();
		    g.drawImage(originalImage, 0, 0, resizeWidth, resizeHeigth, null);
		    g.dispose();
		    // improve quality
