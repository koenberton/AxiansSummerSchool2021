...
public class gpFrequencyDistributionStatFunctions {
	 ...
	 //-----------------------------------------------------------------------	 
	 public double getMeanRoundedDouble(int[] dist)
	 //-----------------------------------------------------------------------
	 {
		 int  n=0;
		 double fx=0;
	 ...
	 //-----------------------------------------------------------------------
	 {
			 return (int)getMeanRoundedDouble(dist);
	 }
	 ...
	 //-----------------------------------------------------------------------
	 {
		 double mean = getMeanRoundedDouble(dist);
		 int  n=0;
		 double fx=0;
		 double sq=0;
		 for(int i=0;i<dist.length;i++)
	 ...
	 //-----------------------------------------------------------------------
	 public double getStdDevDouble(int[] dist)
	 //-----------------------------------------------------------------------
	 {
