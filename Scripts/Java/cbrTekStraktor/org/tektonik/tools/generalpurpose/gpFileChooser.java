...
public class gpFileChooser extends JFileChooser {
          ...
          //-----------------------------------------------------------------------
          {
        	    public boolean accept(File f) {
        	        ...
        	        if( f.getAbsolutePath().toUpperCase().endsWith(".ARFF")) return true;
        	        if( f.getAbsolutePath().toUpperCase().endsWith(".TXT")) return true;
        	        return false;
        	    }
        	    //The description of this filter - needed because displayed
        	    public String getDescription() {
        	        return "WEKA Attribute Relation File";
        	    }
        	}
          ...
          //-----------------------------------------------------------------------
       	  {
        	  ...
        	  if(  tipe.compareToIgnoreCase("ARFF") == 0 ) {
        		  this.setFileFilter( new ARFFFilter());
        	      return true;  		  
        	  }
        	  return true;
          }
