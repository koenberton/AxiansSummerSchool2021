...
public class cmcTextToARFF {
    ...
    //------------------------------------------------------------
    {
        ...
        for(int i=0 ; i<nattribs ; i++)
        {
        	...
        	if( attrib.getTipe() == ARFF_TYPE.STRING ) {
        ...
        if( nvalids != categories.length )
        {
        	...
        	for(int i=0 ; i<categories.length ; i++)
            {
            	ARFFCategory cat = categories[i];
            	if( cat == null ) continue;
            	if( cat.getTipe() == ARFF_TYPE.STRING ) {
    ...
    //------------------------------------------------------------
    {
        ...
        for(int i=0 ; i<categories.length ; i++)
        {
        	ARFFCategory cat = categories[i];
        	if( cat == null ) continue;
        	if( cat.getTipe() == org.tektonik.MachineLearning.ARFF.ARFFEnums.ARFF_TYPE.STRING ) continue;
           	if( cat.getTipe() == org.tektonik.MachineLearning.ARFF.ARFFEnums.ARFF_TYPE.CLASS ) {
        ...
        for(int i=0 ; i<categories.length ; i++)
        {
        	...
        	if( (cat.getTipe() == ARFF_TYPE.NUMERIC) || (cat.getTipe() == ARFF_TYPE.NOMINAL) ) {
