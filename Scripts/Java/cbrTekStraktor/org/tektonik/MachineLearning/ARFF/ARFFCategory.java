...
public class ARFFCategory {
	    ...
	    public void setTipe(ARFF_TYPE ti  )
	    {
	    	tipe = ti;
	    }
	    ...
	    //------------------------------------------------------------
	    public ARFFCategory(cmcProcSettings is,logLiason ilog,String s , int nrows , ARFF_TYPE ti , int nclasses , String[] nominallist , int nbrbins)
	    //------------------------------------------------------------
	    {
	    	xMSet = is;
			logger=ilog;
			...
			NominalValueList  = ((ti == ARFF_TYPE.NOMINAL)||(ti == ARFF_TYPE.CLASS)) ? nominallist : null;
			//
	    ...
	    //------------------------------------------------------------
	    {
	        if( this.tipe != ARFF_TYPE.NUMERIC ) return true;
