...
public class cmcBayesModel {
	   ...
	   //
	   public cmcBayesModel( int nbins , int nclasses , String s , ARFF_TYPE itipe)
	   {
		   categoryName = s;
		   tipe = itipe;
		   numberOfElements=0;
